...
namespace FootballContractsHistory.Models
{
    public class Club
    {
        ...
        public Club(int clubId, int userId, string? name, string? description, string? creationDate)
        {
            ClubId = clubId;
            UserId = userId;
            Name = name;
        ...
        {
            var getQuery = $"SELECT Club_ID, Userr_ID AS User_ID, Name, Description, Creation_Date " +
